                    ...
                    <div class="card-body">
                        ...
                        <table id="datatable" class="table table-bordered dt-responsive table-responsive nowrap">
                            ...
                            <tbody>
                                ...
                                <tr class="odd">
                                    <td class="" tabindex="0">{{$withdraw->user->name}}</td>
                                    <td>{{$withdraw->account}}</td>
                                    <td>{{$withdraw->types}}</td>
                                        ...
                                        <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                                            <div class="btn-group" role="group">
                                                ...
                                                <ul class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                                    <li><a class="dropdown-item" href="{{route('withdraw.reject', $withdraw->id)}}">Reject</a></li>
                                                    <li><a class="dropdown-item" href="{{route('withdraw.approve', $withdraw->id)}}">Approve</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </td>
