            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <!-- plus icon -->
                        <a href="{{ route('industrial.create') }}">
                        ...
                        <table id="datatable" class="table table-bordered dt-responsive table-responsive nowrap">
                            ...
                            <tbody>
                                @forelse ($industrials as $industrial)
                                <tr class="odd">
                                    <td class="" tabindex="0">{{$industrial->name}}</td>
                                    <td><i class="{{$industrial->icon}}"></i></td>
                                    <td>
                                        <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                                            <div class="btn-group" role="group">
                                                ...
                                                <ul class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                                    <li><a class="dropdown-item" href="{{route('industrial.edit', $industrial->id)}}">Edit</a></li>
                                                    <form action="{{route('industrial.destroy', $industrial->id)}}" method="POST">
                                                        @csrf
                                                        @method('DELETE')
