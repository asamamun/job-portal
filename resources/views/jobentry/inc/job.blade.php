            ...
            <ul class="nav nav-pills d-inline-flex justify-content-center border-bottom mb-5">
                <li class="nav-item">
                    <a class="d-flex align-items-center text-start mx-3 ms-0 pb-3 active" data-bs-toggle="pill"
                        href="#tab-1">
                        <h6 class="mt-n1 mb-0">Functional</h6>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="d-flex align-items-center text-start mx-3 pb-3" data-bs-toggle="pill" href="#tab-2">
                        <h6 class="mt-n1 mb-0">Industrial</h6>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="d-flex align-items-center text-start mx-3 me-0 pb-3" data-bs-toggle="pill" href="#tab-3">
                        <h6 class="mt-n1 mb-0">Special Skills</h6>
                    </a>
                </li>
            </ul>
                ...
                <div id="tab-1" class="tab-pane fade show p-0 active">
                    ...
                    <div class="row">
                        @foreach ($functionals as $functional)
                            <div class="col-md-4 job-item mb-4 p-4">
                                <div class="row g-4">
                                    <div class="d-flex align-items-center">
                                        <a href="{{ route('functional.category', $functional->id) }}"><img
                                                class="flex-shrink-0 img-fluid border rounded"
                                                src="{{ asset('jobentry/img/com-logo-1.jpg ') }}" alt=""
                                    ...
                                    <div
                                        ...
                                        <div class="d-flex mb-3">
                                            ...
                                            <a class="btn btn-primary"
                                                href="{{ route('functional.category', $functional->id) }}">Go Now</a>
                                        </div>
                    ...
                    <div class="row">
                        @foreach ($industrials as $industrial)
                            <div class="col-md-4 job-item mb-4 p-4">
                                <div class="row g-4">
                                    <div class="d-flex align-items-center">
                                        <a href="{{ route('industrial.category', $industrial->id) }}"><img
                                                class="flex-shrink-0 img-fluid border rounded"
                                                src="{{ asset('jobentry/img/com-logo-1.jpg ') }}" alt=""
                                                style="width: 80px; height: 80px;"></a>
                                        <div class="text-start ps-4">
                                            <h5 class="mb-3">{{ $industrial->name }}</h5>
                                            <span class="text-truncate me-3"><i
                                                    class="fa fa-map-marker-alt text-primary me-2"></i>New York,
                                                USA</span>
                                        </div>
                                    ...
                                    <div
                                        ...
                                        <div class="d-flex mb-3">
                                            <a class="btn btn-light btn-square me-3" href=""><i
                                                    class="far fa-heart text-primary"></i></a>
                                            <a class="btn btn-primary"
                                                href="{{ route('industrial.category', $industrial->id) }}">Go Now</a>
                                        </div>
                                        <small class="text-truncate"><i
                                                class="far fa-calendar-alt text-primary me-2"></i>Date Line: 01 Jan,
                                            2045</small>
                ...
                <div id="tab-3" class="tab-pane fade show p-0">
                    ...
                    @foreach ($specials as $special)
                        <div class="col-md-4 job-item mb-4 p-4">
                            <div class="row g-4">
                                <div class="d-flex align-items-center">
                                    <a href="{{ route('special.category', $special->id) }}"><img
                                            class="flex-shrink-0 img-fluid border rounded"
                                            src="{{ asset('jobentry/img/com-logo-1.jpg ') }}" alt=""
                                            style="width: 80px; height: 80px;"></a>
                                    <div class="text-start ps-4">
                                ...
                                <div
                                    ...
                                    <div class="d-flex mb-3">
                                        <a class="btn btn-light btn-square me-3" href=""><i
                                                class="far fa-heart text-primary"></i></a>
                                        <a class="btn btn-primary"
                                            href="{{ route('special.category', $special->id) }}">Go Now</a>
                                    </div>
                                    <small class="text-truncate"><i
                                            class="far fa-calendar-alt text-primary me-2"></i>Date Line: 01 Jan,
                                        2045</small>
